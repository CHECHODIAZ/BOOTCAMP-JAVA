    ...
    <main>
        ...
        <h1 class="fw-bold">Bienvenido!</h1>
			<div class="text-center">
				<div class="card-body">
					<h2 class="card-title">Registro material audiovisual</h2>
        ...
        <section class="container-fluid">   
            <div class="row"> 
				<div class="col">
					 <form class="row g-3 needs-validation" action="<%=request.getContextPath()%>/CreateServlet" method="post">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<label class="form-label">Director</label> <input type="text"
								name="DIRECTOR" class="form-control" id="validationCustom02"
								 required>
							<div class="valid-feedback"></div>
						</div>
                         <div class="col-md-3">
							<label class="form-label">Genero</label> <select
								class="form-select" name="GENDER" id="validationCustom04"
								required>
						...
						<div class="col-md-9">
							<label class="form-label" Style=>Breve Descripción</label> <input
								type="text" name="SUMMARY" class="form-control">
						</div>
						<div class="col-12">
