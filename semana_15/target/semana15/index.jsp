...
<html lang="es">
  ...
  <body>
    ...
    <main>
         <form class="row g-3 needs-validation" action=RegistroServlet method="post">
  <div class="col-md-4">
    <label class="form-label">Nombre</label>
    <input type="text" class="form-control"  value="Ingrese nombre" required>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom02" value="Ej:Diaz" required>
    <div class="valid-feedback">
